INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "The Simpsons", 1, 1), (2, "Comedy", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "The Artemis Fowl"), (2, "Pulp Fiction");

INSERT INTO authors (id, name) VALUES (1, "Kiss Me Goodnight"), (2, "Kings");

INSERT INTO books (id, title, year, series_id) VALUES (1, "The Office", 1990, 1), (2, "Austin's Diary", 1998, 1), (3, "A Storm of Swords", 2000, 1), (4, "First Book", 2002, 2), (5, "Second Book", 2003, 2), (6, "Third Book", 2005, 2);
